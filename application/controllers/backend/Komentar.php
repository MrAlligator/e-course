...
class Komentar extends CI_Controller
{
    ...
    public function index()
    {
        //PAGINATION
        //Config
        $config['base_url'] = 'http://' . $_SERVER['HTTP_HOST'] . str_replace(basename($_SERVER['SCRIPT_NAME']), "", $_SERVER['SCRIPT_NAME']) . 'backend/komentar/index';
        $config['total_rows'] = $this->Komentar_model->hitung_jumlah_komentars();
        $config['per_page'] = '10';
        ...
        $data['komentars'] = $this->Komentar_model->getSome($config['per_page'], $data['start']);
    ...
    public function search()
    {
        ...
        $data['start'] = $this->uri->segment(4);
        $data['title'] = "Data Komentar";
        $data['komentars'] = $this->Komentar_model->getSome($config['per_page'], $data['start'], $like);
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Komentar_model->delete($id)) {
            ...
            redirect(site_url('backend/komentar'));
        }
    }
}
