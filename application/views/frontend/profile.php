...
<div class="col-lg-4 mt-4 mt-lg-0">
  <div class="member d-flex align-items-start">
    ...
    <p><h4 class="text-center"><?=$user['nama']?></h4></p>
  ...
  <div class="collapse" id="ubah-profil">
    <form action="<?=base_url('profile/changeProfile')?>" method="post">
      <div class="row justify-content-end">
        ...
        <input type="file" accept="image/*" class="form-control" onchange="previewFile(this);" name="foto_user" id="foto"><p></p>
        <label for="name"><h6>Nama baru</h6></label>
        <input type="text" name="newName"  class="form-control" aria-label="Nama Baru" value="<?=$user['nama']?>"><p></p>
      </div><p></p>
      <div class="row justify-content-end">
...
<div class="member d-flex align-items-start">
  <dl class="row">
  <div class="card card-header"><h4 class="text-center">Data Diri</h4></div><p></p>
    <dt class="col-sm-4"><h5>Alamat Email</h5></dt>
    <dd class="col-sm-8"><h5>: <?=$user['email']?></h5></dd>
    <dt class="col-sm-4"><h5>Nomor HP</h5></dt>
    <dd class="col-sm-8"><h5>: <?=$user['nomor_hp']?></h5></dd>
    <dt class="col-sm-4"><h5>Tanggal Lahir</h5></dt>
    <dd class="col-sm-8"><h5>: <?= date('d F Y',$user_detail['tanggal_lahir'])?></h5></dd>
    <dt class="col-sm-4"><h5> Jenis Kelamin</h5></dt>
    <dd class="col-sm-8"><h5>: <?=$user_detail['jenis_kelamin']?></h5></dd>
    <dt class="col-sm-4"><h5>Tempat Tinggal</h5></dt>
    <dd class="col-sm-8"><h5>: <?=$user_detail['kota_tempat_tinggal']?></h5></dd>
...
<!-- Card Data Perusahaan -->
  <div class="member d-flex align-items-start">
  <dl class="row">
    <div class="card card-header"><h4 class="text-center">Data Perusahaan</h4></div><p></p>
      <dt class="col-sm-4"><h5>Nama Usaha</h5></dt>
      <dd class="col-sm-8"><h5>: <?=$user_detail['nama_usaha']?></h5></dd>
      <dt class="col-sm-4"><h5>Alamat Usaha</h5></dt>
      <dd class="col-sm-8"><h5>: <?=$user_detail['alamat_usaha']?></h5></dd>
      <dt class="col-sm-4"><h5>Kota Lokasi</h5></dt>
      <dd class="col-sm-8"><h5>: <?=$user_detail['kota_lokasi_usaha']?></h5></dd>
      <dt class="col-sm-4"><h5>Tahun Berdiri</h5></dt>
      <dd class="col-sm-8"><h5>: <?=$user_detail['tahun_berdiri_usaha']?></h5></dd>
      <dt class="col-sm-4"><h5>Email Usaha</h5></dt>
      <dd class="col-sm-8"><h5>: <?=$user_detail['email_usaha']?></h5></dd>
      <dt class="col-sm-4"><h5>No Telepon</h5></dt>
      <dd class="col-sm-8"><h5>: <?=$user_detail['no_telepon']?></h5></dd>
      <dt class="col-sm-4"><h5>Produk Ekspor</h5></dt>
      <dd class="col-sm-8"><h5>: <?=$user_detail['produk_ekspor']?></h5></dd>
      <dt class="col-sm-4"><h5>Jumlah Karyawan</h5></dt>
      <dd class="col-sm-8"><h5>: <?=$user_detail['jumlah_karyawan']?> Orang</h5></dd>
      <dt class="col-sm-4"><h5>Omset Pertahun</h5></dt>
      <dd class="col-sm-8"><h5>: Rp. <?= number_format($user_detail['omset_pertahun'],2,',','.')?></h5></dd>
...
<div class="collapse" id="ubah-data-perusahaan">
  ...
  <input value="<?=$user_detail['alamat_usaha']?>" type="text" name="alamat_usaha" class="form-control" id="alamat_usaha"><p></p>
                    
  <label><h6>Kota Lokasi Usaha</h6></label>
  <input value="<?=$user_detail['kota_lokasi_usaha']?>" type="text" class="form-control" name="kota_usaha" id="kota_usaha"><p></p>
  ...
  <input value="<?=$user_detail['produk_ekspor']?>" type="text" name="produk_ekspor" class="form-control" id="produk_ekspor"><p></p>
