    ...
    <div class="card">
        <div class="card-header border-0">
            ...
            <div class="row align-items-center">
                <div class="col">
                    <form method="POST" action="<?= base_url('backend/logger/searchInquiry') ?>" class="navbar-search navbar-search-light form-inline mr-sm-3">
                        <div class="form-group mb-0">
                            <div class="input-group input-group-alternative input-group-merge">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <a href="<?= base_url('backend/logger/indexInquiry') ?>" class="input-group-text"><i class="fas fa-sync-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    </form>
