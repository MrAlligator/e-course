...
class Postingan_model extends CI_Model
{
    ...
    {
        $this->db->select('a.id_post, a.id_user, a.id_kategori, a.postingan, a.tanggal,
    ...
    {
        $this->db->select('a.id_post, a.id_user, a.id_kategori, a.postingan AS postingan, a.tanggal, b.id_user, b.nama, b.email, c.id_kategori, c.nama_kategori');
        if ($like) {
